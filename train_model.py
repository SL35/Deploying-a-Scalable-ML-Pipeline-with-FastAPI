...
# Binarize and encode training data features
X_train, y_train, encoder, lb = process_data(train,
                                             categorical_features=cat_features,
                                             label='salary')

# Binarize and encode testing data features
...
for col in cat_features:
    ...
    for slicevalue in sorted(test[col].unique()):
        ...
        p, r, fb = performance_on_categorical_slice(test,
                                                    col,
                                                    slicevalue,
                                                    categorical_features=cat_features,
                                                    label="salary",
